...
- **Empfohlen mit sichtbarem Browser**: Im sichtbaren Modus sieht der Kandidat den Browser, und der Agent kann mit der Seite interagieren.
- **Ohne Browser**: Der Kandidat teilt einen Screenshot oder fügt die Fragen manuell ein.
...
**Mit Browser:** Snapshot der aktiven Seite. Titel, URL und sichtbaren Inhalt lesen.

**Ohne Browser:** Den Kandidaten bitten, eines der folgenden zu tun:
