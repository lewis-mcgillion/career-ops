...
2. **Für jede offene URL**:
   ...
   b. **Stellenanzeige extrahieren** mit Browser-Navigation (navigate + snapshot) → WebFetch → WebSearch
...
1. **Browser-Navigation (bevorzugt):** Navigate + Snapshot. Funktioniert mit allen SPAs.
2. **WebFetch (Fallback):** Für statische Seiten oder wenn Browser-Navigation nicht verfügbar ist.
...
- **StepStone / XING / kununu**: Häufig deutscher Markt, oft Cookie-Banner. Browser-Navigation kann Snapshot scrollen, um den Anzeigentext zu erfassen
