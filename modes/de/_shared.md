...
| Browser | Prüfen, ob Stellenanzeigen noch aktiv sind (navigate + snapshot), Stellenanzeigen aus SPAs extrahieren. **KRITISCH: NIEMALS 2+ Agenten parallel mit Browser starten — sie teilen sich eine Browser-Instanz** |
