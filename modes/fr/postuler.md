...
- **Ideal avec navigateur visible** : En mode visible, le candidat voit le navigateur et l'agent peut interagir avec la page.
- **Sans navigateur** : le candidat partage une capture d'ecran ou colle les questions manuellement.
...
**Avec navigateur :** Snapshot de la page active. Lire titre, URL et contenu visible.

**Sans navigateur :** Demander au candidat de :
