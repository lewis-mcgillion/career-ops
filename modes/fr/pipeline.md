...
2. **Pour chaque URL en attente** :
   ...
   b. **Extraire l'offre** avec Browser navigation (navigate + snapshot) -> WebFetch -> WebSearch
...
1. **Browser navigation (prefere) :** Navigate + snapshot. Fonctionne avec toutes les SPAs.
2. **WebFetch (fallback) :** Pour les pages statiques ou quand le navigateur n'est pas disponible.
...
- **Welcome to the Jungle / Indeed FR / APEC** : Portails francophones courants. Browser navigation gere bien les cookie banners
