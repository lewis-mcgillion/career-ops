...
| Browser | Verifier si les offres sont actives (navigate + snapshot), extraire les offres depuis des SPAs. **CRITIQUE : JAMAIS 2+ agents en parallele avec Browser -- ils partagent la meme instance navigateur** |
